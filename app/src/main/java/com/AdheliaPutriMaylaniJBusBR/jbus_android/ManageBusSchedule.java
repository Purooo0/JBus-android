...
import com.AdheliaPutriMaylaniJBusBR.jbus_android.model.Schedule;
...
/**
 * Activity class for managing bus schedules.
 * Allows users to view and add schedules for a specific bus.
 *
        ...
        mApiService.addSchedule(busID, selectedDate).enqueue(new Callback<BaseResponse<Bus>>() {
            ...
            public void onResponse(Call<BaseResponse<Bus>> call, Response<BaseResponse<Bus>> response) {
                ...
                for (Schedule s : l) {
                    ...
                    String date  = dateFormat.format(s.departureSchedule);
                    schedule.add(date);
                }
                ArrayAdapter adapter = new ArrayAdapter<>(mContext, android.R.layout.simple_list_item_1, schedule);
